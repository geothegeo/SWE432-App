...
static String Path    = "";
static String Servlet = "TwoInClassButtons";

// Button labels
static String OpAdd1 = "Concat AB";
static String OpAdd2 = "Concat BA";
   ...
   throws ServletException, IOException
{
   ...
   {
      rslt = new String(valA + valB);
   }
   else if (operation.equals(OpAdd2))
   {
      rslt = new String(valB + valA);
   }
...
private void PrintHead (PrintWriter out)
{
   ...
   out.println("<head>");
   out.println("<title>Two buttons example for Week 5 In-Class Exercise</title>");
...
private void PrintBody (PrintWriter out, String lhs, String rhs, String rslt)
{
   ...
   out.println("   <td><input type=\"text\" name=\"RSLT\" value=\"" + rslt + "\" size=6>");
   out.println("  </tr>");
   out.println(" </table>");
   out.println(" <br>");
   out.println(" <br>");
   out.println(" <input type=\"submit\" value=\"" + OpAdd1 + "\" name=\"Operation\">");
   out.println(" <input type=\"submit\" value=\"" + OpAdd2 + "\" name=\"Operation\">");
