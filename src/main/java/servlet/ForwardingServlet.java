  ...
  ********************************************************************* */
  ...
  // Other strings.
    ...
    private void PrintHead (PrintWriter out)
    {
      ...
      out.println(" predicate += document.getElementById(\"var\" + i).value + \"  \"; } predicateTxt.innerHTML = predicate; document.getElementById(\"predicate\").value = predicate;}");
    ...
    private void PrintBody (PrintWriter out, String predicate, String printTable)
    {
      ...
      out.println("George worked on researching forwarding and how we can implement it. Morgan implemented the new servlet behavior.</p>");
      out.println("</div>");
